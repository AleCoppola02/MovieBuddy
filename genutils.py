...
"""
    def geneticAlgorithm(userInput:dict, toolbox, pop_size=10, cxpb=0.2, mutpb=0.02, min_iter = 5, max_iter = 15):
    ...
    # ------------- MAIN LOOP -------------
    while gen < max_iter and not no_improvement:
        gen += 1
        # Mandatory first 5 generations
        if gen > min_iter:
        ...
        # ---- 4. Clone the offspring (DEAP convention) ----
        ...
        # ---- 7. Re-evaluate individuals with invalid fitness ----
