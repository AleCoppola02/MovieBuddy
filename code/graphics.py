...
def promptGeneticInputs():
    ...
    """
    root = getRoot()
    root.title("What kind of movie do you want to watch today?")
    ...
    # LENGTH SLIDER
    # ------------------------
    tk.Label(root, text="Movie Length (40–240 minutes):", font=("Arial", 13, "bold")).pack(pady=15)
...
class MovieRaterGUI:
    def __init__(self, root, firstPhaseResult):
        ...
        """
        self.root = root
        self.root.title("Rate these movies")
...
class MovieExplanationGUI:
    def __init__(self, movie: int, preferences: dict):
        ...
        """
        self.root = tk.Tk()
        self.root.title("Watch this movie")
