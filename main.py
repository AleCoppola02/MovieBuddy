...
from genutils import geneticAlgorithm, getToolbox, evaluate
import graphics
from graphics import promptGeneticInputs, promptUserPreference, getRoot, SimpleLoadingScreen, MovieExplanationGUI
...
inputPreferences = promptUserPreference(firstPhaseResults[20])
